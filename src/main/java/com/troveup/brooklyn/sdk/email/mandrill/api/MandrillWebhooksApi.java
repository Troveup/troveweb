 ...
 * @since Mar 19, 2013
 */
public class MandrillWebhooksApi extends MandrillApiCommon {
	private static final String rootUrl = MandrillUtil.rootUrl;
	private final String key;
	
	public MandrillWebhooksApi(final String key, IHttpClientFactory httpClientFactory)
	{
	...
	public MandrillWebhook[] list() throws MandrillApiError,
		...
		return MandrillUtil.query(
				...
				MandrillWebhook[].class, httpClientFactory);
	...
	public MandrillWebhook add(final String url, final String description, 
		...
		return MandrillUtil.query(rootUrl+ "webhooks/add.json", 
				params, MandrillWebhook.class, httpClientFactory);
