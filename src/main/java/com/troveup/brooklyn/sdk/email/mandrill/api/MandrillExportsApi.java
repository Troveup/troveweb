 ...
 *
 */
public class MandrillExportsApi extends MandrillApiCommon {
	private static final String rootUrl = MandrillUtil.rootUrl;
	private final String key;
	
	public MandrillExportsApi(final String key, IHttpClientFactory httpClientFactory)
	{
	...
	public MandrillExportJobInfo info(final String id) 
		...
		return MandrillUtil.query(rootUrl+ "exports/info.json", 
				params, MandrillExportJobInfo.class, httpClientFactory);
	...
	public MandrillExportJobInfo list() 
		...
		return MandrillUtil.query(rootUrl+ "exports/list.json", 
				...
				MandrillExportJobInfo.class, httpClientFactory);
