...
public class MandrillSubaccountsApi extends MandrillApiCommon{
	private static final String rootUrl = MandrillUtil.rootUrl;
	private final String key;
	
	public MandrillSubaccountsApi(final String key, IHttpClientFactory httpClientFactory)
	{
	...
	public MandrillSubaccountInfo[] list(final String q) 
		...
		return MandrillUtil.query(rootUrl+ "subaccounts/list.json", 
				params, MandrillSubaccountInfo[].class, httpClientFactory);
