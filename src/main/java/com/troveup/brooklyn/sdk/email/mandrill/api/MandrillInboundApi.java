 ...
 * @since Mar 19, 2013
 */
public class MandrillInboundApi extends MandrillApiCommon {
	private static final String rootUrl = MandrillUtil.rootUrl;
	private final String key;
	
	public MandrillInboundApi(final String key, IHttpClientFactory httpClientFactory)
	{
	 ...
	 */
	 MandrillInboundDomain[] domains() 
		...
		return MandrillUtil.query(
				...
				MandrillInboundDomain[].class, httpClientFactory);
	 ...
	 */
	 MandrillMailboxRoute[] routes(final String domain)
		...
		return MandrillUtil.query(rootUrl+ "inbound/routes.json", 
				params, MandrillMailboxRoute[].class, httpClientFactory);
	 ...
	 */
	 MandrillInboundRecipient[] sendRaw(final String rawMessage, 
		...
		return MandrillUtil.query(rootUrl+ "inbound/send-raw.json", 
				params, MandrillInboundRecipient[].class, httpClientFactory);
