 ...
 * @since Mar 19, 2013
 */
public class MandrillSendersApi extends MandrillApiCommon{
	private static final String rootUrl = MandrillUtil.rootUrl;
	private final String key;
	
	public MandrillSendersApi(final String key, IHttpClientFactory httpClientFactory)
	{
	...
	public MandrillSender[] list() 
		...
		return MandrillUtil.query(
				...
				MandrillSender[].class, httpClientFactory);
	...
	public MandrillDomain[] domains() 
		...
		return MandrillUtil.query(
				...
				MandrillUtil.paramsWithKey(key), 
				MandrillDomain[].class, httpClientFactory);
	...
	public MandrillDomain addDomain(final String domain) 
		...
		return MandrillUtil.query(rootUrl+ "senders/add-domain.json", 
				params, MandrillDomain.class, httpClientFactory);
	 ...
	 * @throws IOException
	 */
	public MandrillDomain.MandrillDomainVerificationInfo verifyDomain(
		...
		return MandrillUtil.query(rootUrl+ "senders/verify-domain.json", 
				params, MandrillDomain.MandrillDomainVerificationInfo.class, httpClientFactory);
	...
	public MandrillSender info(final String address) 
		...
		return MandrillUtil.query(rootUrl+ "senders/info.json", 
				params, MandrillSender.class, httpClientFactory);
