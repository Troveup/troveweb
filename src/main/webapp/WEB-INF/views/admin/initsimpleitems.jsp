...
<div class="container-fluid">
    <form class="new-collection form-horizontal" style="padding-top: 50px;" action="/admin/initsimpleitemspost?${_csrf.parameterName}=${_csrf.token}"
          method='POST'>
        <div class="form newCollection">
            <input type="submit" style="margin-left: 500px" value="Initialize Simple Items">
        </div>
    </form>
</div>
<c:choose>
