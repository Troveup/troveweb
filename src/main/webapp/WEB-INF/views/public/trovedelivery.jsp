...
<html>
  <head>
    <title> Trove: Legal - Sales, Shipping & Delivery </title>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="cardy sidemenu">
            <ul class="nav bs-docs-sidenav">
              <li class="sidelink"><a href="/legal/privacy">Privacy Policy</a> </li>
              <li class="sidelink"><a href="/legal/terms">Terms of Service</a> </li>
              <li class="sidelink"><a href="/legal/copyright">Copyright Policy</a> </li>
              <li class="sidelink"><a class="active" href="/legal/sales">Sales Policy</a> </li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-sm-9">
          <div class="cardy privacy"> 
            ...
            <p>The cost of shipping is free for all domestic orders. Trove uses United Parcel Service (UPS) to ship all orders by UPS Express Saver.</p>

            <b>No Delivery to a P.O. Box</b>
            <p>UPS will only accept shipments to a street address, which means that Trove cannot deliver to a P.O. Box.</p>

            <b>Tracking Your Package</b>
            <p>Upon shipment of your order, Trove will send you an email notice with the UPS tracking number and expected delivery date. You can click on the tracking number to track your package on the UPS website. In addition, you can track the progress of your order by logging onto the Trove website and checking the Orders page in your profile.</p>
