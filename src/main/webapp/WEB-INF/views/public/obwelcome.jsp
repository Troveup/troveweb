...
<html>
  ...
  <body class="confirm">
    ...
    <div class="centrafuge"> 
      ...
      <h5>Before we begin, we'd like to quickly show you
      how to customize your own 3D-printed jewelry.</h5>
      ...
      <a id="biggbutton" href="/public/cust/51" class="btn btn--red btn--product--description customize" role="button" data-tooltip="Customize this!" onclick="custb()"><img src="https://storage.googleapis.com/trove-demo-cdn/img/remix-icon-white.svg" class="icon-btn" alt="Remakes"> Customize</a>
    ...
    <script>
      function land() {
        mixpanel.track("onboarding_land_page1");
      };

      

      $("#biggbutton").click(function () {
        mixpanel.track("onboarding_page1");
      });
